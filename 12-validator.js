...
Validator.isEmail = function (selector) {
    return {
        ...
        test: function (value) {
            ...
            return regexEmail.test(value) ? undefined : 'Đây không phải là email' 
        }
    }
}
...
Validator.isConfirmed = function(selector, getConfirmValue, errorMessage) {
    return {
        selector: selector,
        test: function (value) {
            return value === getConfirmValue() ? undefined : errorMessage || 'Giá trị nhập vào không chính xác'
        }
    }
}
